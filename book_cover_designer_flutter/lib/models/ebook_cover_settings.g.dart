...
_$EbookCoverSettingsImpl _$$EbookCoverSettingsImplFromJson(
        Map<String, dynamic> json) =>
    _$EbookCoverSettingsImpl(
      ...
      titleTextColor: json['titleTextColor'] == null
          ? Colors.white
          : const ColorJsonConverter()
              .fromJson((json['titleTextColor'] as num).toInt()),
      authorTextColor: json['authorTextColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['authorTextColor'] as num).toInt()),
      subtitleTextColor: json['subtitleTextColor'] == null
          ? Colors.black
          : const ColorJsonConverter()
              .fromJson((json['subtitleTextColor'] as num).toInt()),
      titleBoxColor: json['titleBoxColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['titleBoxColor'] as num).toInt()),
      authorBoxColor: json['authorBoxColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['authorBoxColor'] as num).toInt()),
      subtitleBoxColor: json['subtitleBoxColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['subtitleBoxColor'] as num).toInt()),
      taglineTextColor: json['taglineTextColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['taglineTextColor'] as num).toInt()),
      taglineBoxColor: json['taglineBoxColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['taglineBoxColor'] as num).toInt()),
      seriesTitleTextColor: json['seriesTitleTextColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['seriesTitleTextColor'] as num).toInt()),
      seriesTitleBoxColor: json['seriesTitleBoxColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['seriesTitleBoxColor'] as num).toInt()),
      editionLineTextColor: json['editionLineTextColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['editionLineTextColor'] as num).toInt()),
      editionLineBoxColor: json['editionLineBoxColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['editionLineBoxColor'] as num).toInt()),
      cornerBadgeTextColor: json['cornerBadgeTextColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['cornerBadgeTextColor'] as num).toInt()),
      cornerBadgeColor: json['cornerBadgeColor'] == null
          ? Colors.white70
          : const ColorJsonConverter()
              .fromJson((json['cornerBadgeColor'] as num).toInt()),
      layout: $enumDecodeNullable(_$CoverLayoutEnumMap, json['layout']) ??
          CoverLayout.bigCenterTitle,
      taglineTopOffset: (json['taglineTopOffset'] as num?)?.toDouble() ?? 0,
      seriesTitleTopOffset:
          (json['seriesTitleTopOffset'] as num?)?.toDouble() ?? 0,
      editionLineTopOffset:
          (json['editionLineTopOffset'] as num?)?.toDouble() ?? 0,
      ...
      cornerBadgePosition: $enumDecodeNullable(
              _$CornerBadgePositionEnumMap, json['cornerBadgePosition']) ??
          CornerBadgePosition.topRight,
      backgroundImageBytes: const Uint8ListBase64Converter()
          .fromJson(json['backgroundImageBytes'] as String?),
      backgroundImageMode: $enumDecodeNullable(
              _$BackgroundImageModeEnumMap, json['backgroundImageMode']) ??
...
Map<String, dynamic> _$$EbookCoverSettingsImplToJson(
        _$EbookCoverSettingsImpl instance) =>
    <String, dynamic>{
      ...
      'titleTextColor':
          const ColorJsonConverter().toJson(instance.titleTextColor),
      'authorTextColor':
          const ColorJsonConverter().toJson(instance.authorTextColor),
      'subtitleTextColor':
          const ColorJsonConverter().toJson(instance.subtitleTextColor),
      'titleBoxColor':
          const ColorJsonConverter().toJson(instance.titleBoxColor),
      'authorBoxColor':
          const ColorJsonConverter().toJson(instance.authorBoxColor),
      'subtitleBoxColor':
          const ColorJsonConverter().toJson(instance.subtitleBoxColor),
      'taglineTextColor':
          const ColorJsonConverter().toJson(instance.taglineTextColor),
      'taglineBoxColor':
          const ColorJsonConverter().toJson(instance.taglineBoxColor),
      'seriesTitleTextColor':
          const ColorJsonConverter().toJson(instance.seriesTitleTextColor),
      'seriesTitleBoxColor':
          const ColorJsonConverter().toJson(instance.seriesTitleBoxColor),
      'editionLineTextColor':
          const ColorJsonConverter().toJson(instance.editionLineTextColor),
      'editionLineBoxColor':
          const ColorJsonConverter().toJson(instance.editionLineBoxColor),
      'cornerBadgeTextColor':
          const ColorJsonConverter().toJson(instance.cornerBadgeTextColor),
      'cornerBadgeColor':
          const ColorJsonConverter().toJson(instance.cornerBadgeColor),
      ...
      'backgroundImageBytes': const Uint8ListBase64Converter()
          .toJson(instance.backgroundImageBytes),
      'backgroundImageMode':
          _$BackgroundImageModeEnumMap[instance.backgroundImageMode]!,
      'backgroundImageAlignment':
          const AlignmentConverter().toJson(instance.backgroundImageAlignment),

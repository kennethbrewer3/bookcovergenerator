...
--
-- Class CoverSize as table cover_size
--
...
--
-- Class SeriesTitle as table series_title
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('book_cover_designer', '20260525203125597', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260525203125597', "timestamp" = now();
